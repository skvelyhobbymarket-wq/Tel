...
VHODNOST = {  # (skóre 1-5, poznámka)
 ...
 'Úklid a čisticí prostředky': (4,'Savo, Domestos, pytle na odpad, houbičky, Solvina. Objemnější, nižší marže – vybrat jen top 30 položek.'),
 ...
 'Spreje': (2,'Barvy ve spreji 120–250 Kč: hořlavé, riziko krádeže a zneužití (graffiti). Bez obsluhy jen omezeně, spíš ne.'),
 'Nátěrové hmoty (barvy, laky, lazury)': (2,'Největší obrat prodejny (24 %), ale kbelíky 15+3 kg, tónování a poradenství se bez obsluhy nedají. Max. bílá malířská 1–4 kg a pár lazur 0,75 l.'),
 'Osobní kosmetika': (2,'V hobbymarketu se prodává málo (67 ks/měs), silná konkurence supermarketů. Jen dezinfekce, náplasti.'),
 'Stavební chemie a sádra': (1,'Pytle 25 kg, poradenství. Výjimka: sádra 1–3 kg.'),
